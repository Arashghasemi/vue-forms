...
const card = ref({});
function onSubmit() {
  error.value = "Can't have yet, no API";
}
...
<template>
  ...
  <div class="container bg-slate-300 mx-auto p-2">
    ...
    <div>
      <!-- To prevent the page to set the form to default you can either -->
      <!-- set return to false in onSubmit function or e.preventDefault or set @submit.prevent -->
      <form novalidate @submit.prevent="onSubmit">
        ...
        <div class="w-1/2">
          ...
          <div>
            ...
            <input type="text" id="ccv" v-model="ccv">
          </div>
        </div>
        </div>
